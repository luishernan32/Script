...
SET    consulta=   'SELECT f.numero_financiacion,
...
WHERE  df.id_detalle_financiacion = :idCuota '               
	   , orden_variables='NUMERO_OBLIGACION,NOMBRE_COMPLETO,T_DOCUMENTO_INFRACTOR,DOCUMENTO_INFRACTOR,COMENTARIO,NUMERO_CUOTAS,FECHA_PAGO_OPORTUNO,TOTAL_FINANCIADO,VALOR_CUOTA,VALOR_INT,ESTADO_FINANCIACION,NUMERO_PAGO,TITULO_PLANTILLAS'
WHERE  id_plantilla_config=10
