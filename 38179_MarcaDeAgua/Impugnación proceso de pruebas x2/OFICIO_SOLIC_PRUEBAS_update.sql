...
SET    consulta=   'SELECT Concat(spb.consecutivo_documento, ''-'', Year(Getdate())),
...
WHERE  pr.id_proceso = :idProceso
	   ...
	   , orden_variables='CONSECUTIVO_PRUEBAS,PARA,numero_consecutivo,NOMBRE_INFRACTOR,DOCUMENTO_INFRACTOR,numero_citacion,DESCRIPCION_PRUEBA,TITULO_PLANTILLAS'
WHERE  id_plantilla_config=55
