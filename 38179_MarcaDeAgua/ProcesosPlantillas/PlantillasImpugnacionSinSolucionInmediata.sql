...
--SIN ID PLANTILLA CONFIG

--COA_MTV_MDCT_SPP 3680 no tiene id_plantilla_config <12>
--COA_EXC_VEL_INF_ATD 3686 No tiene id_plantilla_config   <12> probado
--COA_EXC_VEL_FDS 3687 No tiene id_plantilla_config <12> probado
--COA_VACT_PP_AI 3688 No tiene id_plantilla config <>
--COA_A_EV_AU 3683 no tiene id_plantilla_config
...
--Impugnación sin solución inmediata	Coa exceso de velocidad FDS	                                                              COA_EXC_VEL_FDS <12>
--Impugnación sin solución inmediata	COA - versión ACT - período de prueba	                                                  COA_VACT_PP_AI <12>
...
WHERE  id_plantilla_config=12XX
