...
WHERE  pr.id_proceso = :idProceso'               
	   , orden_variables='numero_consecutivo,anio_apertura_proceso,fecha_actual,hora_actual,DOCUMENTO_INFRACTOR,PLACA_VEHICULO,NOMBRE_COMPLETO,MEMO_DELEGADO,FECHA_DELEGADO,REGISTRO_FALLO,IMAGEN_FIRMA,NOMBRE_ABOGADO,CARGO_DELEGADO,TITULO_PLANTILLAS'
WHERE  id_plantilla_config=10158xx
