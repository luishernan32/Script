...
Upper(
       ...
       (SELECT [dbo].[Formatofecha](p.fecha_inicio, 1))    AS fechaGeneracion,
...
WHERE  ob.id_oficio_bien = :idSolicitud '               
	   , orden_variables='NUMERO_PROCESO,fecha_actual,hora_actual,NOMBRE_INFRACTOR,T_DOCUMENTO_INFRACTOR,N_DOCUMENTO_INFRACTOR,FECHA_TEXTO,VALOR_SALDO,VALOR_TOTAL_LETRAS,IMAGEN_FIRMA, LogoATM_variable,NOMBRE_DELEGADO,IMAGEN_FIRMA_DOS,CARGO_DELEGADO,TITULO_PLANTILLAS'
WHERE  id_plantilla_config=84

commit tran


declare @codigoPlantilla varchar(20);
set @codigoPlantilla = 'PROVIDENCIA_RETENCIO';--AUTO_PAGO_PATIO
