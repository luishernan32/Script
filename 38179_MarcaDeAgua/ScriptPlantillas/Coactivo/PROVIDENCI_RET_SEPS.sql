...
--*******************************************************************************************************************************************************************
--Generar documentos----GENERACION SOLICITUD OFICIO BIEN----SuperIntendencia de la economia popular Solicitud busqueda de bienes y se despliegan varias plantillas
--*******************************************************************************************************************************************************************
...
-------------------------------------------------------------------------------------
select *from tipo_documento_proceso
where codigo in(47,48) --Encuentro el nombre de esas dos plantillas que se generan
-------------------------------------------------------------------------------------
begin tran 
update documentos..plantilla set fecha_inicio='2024-08-11' where id_plantilla=4772
update documentos..plantilla set fecha_inicio='2024-08-09' where id_plantilla=4772
commit tran
...
JOIN tipo_identificacion_persona tip (nolock)
  ON tip.id_tipo_identificacion = pe.id_tipo_identificacion
WHERE  ob.id_oficio_bien = :idProceso '               
	   , orden_variables='NUMERO_PROCESO,fecha_actual,hora_actual,NOMBRE_INFRACTOR,T_DOCUMENTO_INFRACTOR,N_DOCUMENTO_INFRACTOR,FECHA_GENERACION,  VALOR_SALDO,VALOR_TOTAL_LETRAS,IMAGEN_FIRMA, LogoATM_variable,NOMBRE_DELEGADO,IMAGEN_FIRMA_DOS,CARGO_DELEGADO,TITULO_PLANTILLAS'
WHERE  id_plantilla_config=10174
