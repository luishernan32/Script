...
AND pre.id_deudor = :deudor
AND id_periodo = :proceso'               
	   , orden_variables='NORMA,NOMBRE_INFRACTOR,DIRECCION_INFRACTOR,hora_actual,FECHA_CALIBRACION,NOMBRE_COMPLETO,DIRECCION_COACTIVA,placa,N_DOCUMENTO_INFRACTOR,TEXTO_NOTIFICACION,NUMERO_OBLIGACION,FECHA_INFRACCION,FECHA_SENTAR_RAZON_FALLO,FECHA_SOLICITUD,VALOR_INTERES,DIAS_COBRO,FECHA_INFRACCION3,VALOR_TOTAL_LETRAS,IMAGEN_FIRMA,IMAGEN_FIRMA_CINCO,IMAGEN_FIRMA_DOS,NOMBRE_ABOGADO,TEXTO_NOMBRE_1,NOMBRE_ABOGADO_PAT,FECHA_EVALUACION,FECHA_SENTAR_RAZON_FALLO,TIPO_BIEN,NUMERO_FACTURA,FECHA_TEXTO,PARRAFO_1,TITULO_PLANTILLAS'
WHERE  id_plantilla_config=10147
...
AND id_periodo = :proceso '               
	   , orden_variables='NORMA,NOMBRE_INFRACTOR,DIRECCION_INFRACTOR,hora_actual,FECHA_CALIBRACION,NOMBRE_COMPLETO,DIRECCION_COACTIVA,placa,N_DOCUMENTO_INFRACTOR,TEXTO_NOTIFICACION,NUMERO_OBLIGACION,FECHA_INFRACCION,FECHA_SENTAR_RAZON_FALLO,FECHA_SOLICITUD,VALOR_INTERES,DIAS_COBRO,FECHA_INFRACCION3,VALOR_TOTAL_LETRAS,IMAGEN_FIRMA,IMAGEN_FIRMA_CINCO,IMAGEN_FIRMA_DOS,NOMBRE_ABOGADO,TEXTO_NOMBRE_1,NOMBRE_ABOGADO_PAT,FECHA_EVALUACION,FECHA_SENTAR_RAZON_FALLO,TIPO_BIEN,NUMERO_FACTURA,FECHA_TEXTO,PARRAFO_1,TITULO_PLANTILLAS'
WHERE  id_plantilla_config=10150
...
------------------------------------------------------------------------------
--original id_plantilla config 10105

--NORMA,NOMBRE_INFRACTOR,DIRECCION_INFRACTOR,hora_actual,FECHA_CALIBRACION,NOMBRE_COMPLETO,DIRECCION_COACTIVA,placa,N_DOCUMENTO_INFRACTOR,TEXTO_NOTIFICACION,NUMERO_OBLIGACION,FECHA_INFRACCION,FECHA_SENTAR_RAZON_FALLO,FECHA_SOLICITUD,VALOR_INTERES,DIAS_COBRO,FECHA_INFRACCION3,VALOR_TOTAL_LETRAS,IMAGEN_FIRMA,IMAGEN_FIRMA_CINCO,IMAGEN_FIRMA_DOS,NOMBRE_ABOGADO,TEXTO_NOMBRE_1,NOMBRE_ABOGADO_PAT,FECHA_EVALUACION,FECHA_SENTAR_RAZON_FALLO,TIPO_BIEN,NUMERO_FACTURA,FECHA_TEXTO,PARRAFO_1,CARGO_DELEGADO
SELECT DISTINCT Concat (pp.numero_ingreso, '-', Year(Sysdatetime()), '-',
                                (SELECT Max(t.numero_proceso)
                                                                           FROM
                                titulo_credito t
                                                                           WHERE
...
------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------
--Original id_plantilla_config=10147
--NORMA,NOMBRE_INFRACTOR,DIRECCION_INFRACTOR,hora_actual,FECHA_CALIBRACION,NOMBRE_COMPLETO,DIRECCION_COACTIVA,placa,N_DOCUMENTO_INFRACTOR,TEXTO_NOTIFICACION,NUMERO_OBLIGACION,FECHA_INFRACCION,FECHA_SENTAR_RAZON_FALLO,FECHA_SOLICITUD,VALOR_INTERES,DIAS_COBRO,FECHA_INFRACCION3,VALOR_TOTAL_LETRAS,IMAGEN_FIRMA,IMAGEN_FIRMA_CINCO,IMAGEN_FIRMA_DOS,NOMBRE_ABOGADO,TEXTO_NOMBRE_1,NOMBRE_ABOGADO_PAT,FECHA_EVALUACION,FECHA_SENTAR_RAZON_FALLO,TIPO_BIEN,NUMERO_FACTURA,FECHA_TEXTO,PARRAFO_1
SELECT DISTINCT Concat (pp.numero_ingreso, '-', Year(Sysdatetime()), '-',
                                (SELECT Max(t.numero_proceso)
                                                                           FROM
                                titulo_credito t
...
------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------
--Original id_plantilla_config 10150
--NORMA,NOMBRE_INFRACTOR,DIRECCION_INFRACTOR,hora_actual,FECHA_CALIBRACION,NOMBRE_COMPLETO,DIRECCION_COACTIVA,placa,N_DOCUMENTO_INFRACTOR,TEXTO_NOTIFICACION,NUMERO_OBLIGACION,FECHA_INFRACCION,FECHA_SENTAR_RAZON_FALLO,FECHA_SOLICITUD,VALOR_INTERES,DIAS_COBRO,FECHA_INFRACCION3,VALOR_TOTAL_LETRAS,IMAGEN_FIRMA,IMAGEN_FIRMA_CINCO,IMAGEN_FIRMA_DOS,NOMBRE_ABOGADO,TEXTO_NOMBRE_1,NOMBRE_ABOGADO_PAT,FECHA_EVALUACION,FECHA_SENTAR_RAZON_FALLO,TIPO_BIEN,NUMERO_FACTURA,FECHA_TEXTO,PARRAFO_1
SELECT DISTINCT Concat (pp.numero_ingreso, '-', Year(Sysdatetime()), '-',
                                (SELECT Max(t.numero_proceso)
                                                                           FROM
