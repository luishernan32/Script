...
WHERE  pr.id_proceso = :idProceso '               
	   , orden_variables='numero_consecutivo,numero_citacion,NOMBRE_INFRACTOR,anio_apertura_proceso,fecha_apertura_impug,T_DOCUMENTO_INFRACTOR,DOCUMENTO_INFRACTOR,TELEFONO_INFRACTOR,NUMERO_CELULAR,CORREO_ELECTRONICO_INFRACTOR,DIRECCION_INFRACTOR,DIRECCION_INFRACCION,desc_motivacion,ARTICULO,DESCRIPCION_INFRACCION,fecha_imposicion,NOMBRE_PARTICIPANTE,T_DOCUMENTO_PARTICIPANTE,DOCUMENTO_PARTICIPANTE,TELEFONO_PARTICIPANTE,CELULAR_PARTICIPANTE,CORREO_PARTICIPANTE,DIRECCION_PARTICIPANTE,NOMBRE_COMPLETO,T_DOCUMENTO_FIRMA,DOCUMENTO_FIRMA,PLACA_VEHICULO,ESTADO_CIVIL,EDAD,PROFESION,PRUEBAS_APORTADAS,OTROS_COA,ESTADO_CIVIL_PART,EDAD_PART,PROFESION_PART,CODIGO_AGENTE,NOMBRE_SECRETARIO,FECHA_SOLICITUD,HORA_SOLICITUD,origen_impugnacion,origen_impugnacion_formulario_2,Prescripcion2,TITULO_PLANTILLAS'
WHERE  id_plantilla_config=27
