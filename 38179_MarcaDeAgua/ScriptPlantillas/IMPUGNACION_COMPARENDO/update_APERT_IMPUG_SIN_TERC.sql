...
WHERE  pr.id_proceso = :idProceso '               
	   , orden_variables='numero_consecutivo,numero_citacion,NOMBRE_INFRACTOR,anio_apertura_proceso,fecha_apertura_impug,T_DOCUMENTO_INFRACTOR,DOCUMENTO_INFRACTOR,TELEFONO_INFRACTOR,NUMERO_CELULAR,CORREO_ELECTRONICO_INFRACTOR,DIRECCION_INFRACTOR,DIRECCION_INFRACCION,desc_motivacion,ARTICULO,DESCRIPCION_INFRACCION,fecha_imposicion,NOMBRE_COMPLETO,PLACA_VEHICULO,ESTADO_CIVIL,EDAD,PROFESION,PRUEBAS_APORTADAS,OTROS_COA,CODIGO_AGENTE,NOMBRE_SECRETARIO,FECHA_SOLICITUD,HORA_SOLICITUD,LogoATM_variable,origen_impugnacion,origen_impugnacion_formulario,prescripcion_texto,TITULO_PLANTILLAS'
