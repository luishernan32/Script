...
SET    consulta=   'SELECT p.numero_proceso,
       ...
       cv.placa_vehiculo,
       Concat(fu.titulo_obtenido, '' '',perd.nombre1, '' '', perd.nombre2, '' '', perd.apellido1, '' '',
...
WHERE  p.id_proceso = :idProceso
	   ...
	   , orden_variables='numero_consecutivo,NOMBRE_COMPLETO,CORREO_ELECTRONICO_INFRACTOR,anio_apertura_proceso,NOMBRE_ABOGADO,PLACA_VEHICULO,NOMBRE_DELEGADO,  CARGO_DELEGADO,IMAGEN_FIRMA,MEMO_DELEGADO,FECHA_DELEGADO,TEXTO_NOMBRE_2,TITULO_PLANTILLAS'
WHERE  id_plantilla_config=10177
