...
SET    consulta=   'SELECT CASE pe.id_tipo_identificacion
       ...
       CASE i.numeral_infraccion
         WHEN '' '' THEN Concat(''articulo '', ci.articulo, '' - '', nm.nombre)
         ELSE Concat(''articulo '', ci.articulo, '',         numeral '',
...
(SELECT TOP 1 CASE fu.id_cargo
                WHEN 3 THEN Concat(co.nombre, '' '',
                            ''delegado del director de gestion'')
                WHEN 1 THEN ''delegado del director de gestion''
                ELSE co.nombre
              END
...
(SELECT CASE
 ...
 WHERE  upet.id_usuario = tp.id_usuario)          TEXTO_NOMBRE_2,
...
WHERE  id_plantilla_config=10196
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--REG_FALL_CONS_PP Modificado query
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--REG_FALL_CONS_PP original query
