...
--N	Código Plantilla	id_plantilla_config	id_plantilla
...
---------------------------------------------------------------------------------------------------------------
--21/11/2023
--Impugnación cierre de pruebas	COA - Cierre de pruebas	COA_CP	11777 id_plantilla=2617 2624
...
--Fusión de los tres procesos de devolución (2709,2708,2710,2711)
------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------
...
--(2680,2681,2682,2683,2684,2723)--Sentar Razón
...
--where id_plantilla in(2676,2677,2678,2679) --Financiación comparendo
--where id_plantilla in(2680,2681,2682,2683,2684)--Sentar Razón
--where id_plantilla in(2686,2687,2688,2689,2690,2691,2692,2693) --Impugnación sin solución inmediata
...
--update documentos..plantilla set fecha_inicio='2023-12-13' where id_plantilla=2526 --New versión de la plantilla que está molestando
--update documentos..plantilla set fecha_inicio='2023-12-13' where id_plantilla in(2676,2677,2678,2679) --Financiación comparendo
--update documentos..plantilla set fecha_inicio='2023-12-12' where id_plantilla in(2680,2681,2682,2683,2684)--Sentar Razón
--update documentos..plantilla set fecha_inicio='2023-12-14' where id_plantilla in(2686,2687,2688,2689,2690,2691,2692,2693) --Impugnación sin solución inmediata
...
--1. Resolución culminación virtual
--2. Resolución incumplimiento virtual
--3. Resolución culminación virtual 100
--4. Resolución incumple virtual 100
...
--5. COA - FOTOMULTAS pruebas pertinentes - Período prueba	COA_FOT_PP_PP	241
--6. COA - MTV ACT dio paso - sin período de prueba	COAMTVACT_DP_SPP	42
--7. MTV SIN PERIODO DE PRUEBA NO MEMO DCT	MTV_SP_DCT_NO_MEMO	3
--8. COA - Pruebas pertinentes - Período prueba	COA_PPI_AU_PP	2
--9. Auto inicial	AUTO_INICIAL_PRUEBA	2
--10. Exceso de velocidad - sistema GPS - Transporte Público	AI_EXV_SGPS_TP	1
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
