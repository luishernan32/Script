...
;
	...
	and 1=1
	and r.NUMERO_JUICIO in('314769-2023','21280-2024','319878-2023',
...
--	in( select  rs.numero_juicio from circulemos2.dbo.reconstruccion_solicitud_busqueda_bienes rs
--where rs.procesado = 0
--and rs.error is not null
--and rs.error = 'El coactivo no ha sido NOTIFICADO'	)
