...
--order variables
numero_consecutivo,FECHA_GENERACION,UBICACION_SEDE,NOMBRE_DELEGADO,NOMBRE_ABOGADO_ASIG,NOMBRE_ABOGADO,NUMERO_MEMORANDO,FECHA_MEMORANDO,FECHA_SOLICITUD,DOCUMENTO_PARTICIPANTE,T_DOCUMENTO_PARTICIPANTE,IMAGEN_FIRMA,DELEGADO_NOMBRAMIENTO_,DELEGADO_TITULONOMBRE_,IMAGEN_FIRMA_DOS,ESTADO