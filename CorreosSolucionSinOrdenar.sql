...
SELECT top 500 -- se modifica para no tener overlaping en generaciones INC 18 nov 20222
        row_number() over (partition by c.correo_electronico order by c.fecha_registro desc) as ranking,
...
--select correo_electronico, fecha_registro
--from circulemos2..correo_persona
--where id_correo_persona in (2902008,2902052)


--select *from circulemos2..persona
--where id_persona in(3906156,5239747)
