...
--Crear la tabla temporal a partir de la Hoja de hoja de excel de los 2031 datos a reconstruir
SELECT * into #tmp_reg_impugnaciones
FROM OPENROWSET( 'Microsoft.ACE.OLEDB.16.0'
,'Excel 12.0; Database=K:\impugnaciones\reconstr_impugnaciones.xlsx;HDR=YES' ,[Sheet1$]);
--Al ejecutarce hay 2031 rows affected
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--Tabla intermedia de lectura:  reconstr_docs_impugnaciones

select * from circulemos2.dbo.reconstr_docs_impugnaciones
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--min init: 36:46 fin:39:35
select 

tr.*

into #tmp_reg_impugnaciones_2

from circulemos2.dbo.proceso pr

inner join circulemos2.dbo.impugnacion i on pr.id_proceso = i.id_proceso

inner join #tmp_reg_impugnaciones tr on tr.[numero juicio] = CONCAT(pr.numero_proceso, '-',YEAR(pr.fecha_inicio)) 

where pr.id_tipo_proceso = 1

and not exists (select 1 from circulemos2.dbo.reconstr_docs_impugnaciones rd

where rd.numero_juicio =tr.[numero juicio] )
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-- 17/06/2024 Reunión Alexander


[09:36] Alexander Abrahan Aguilar Alvarado
...
select * from #tmp_reg_impugnaciones_2
...
FROM  #tmp_reg_impugnaciones_2

where [numero juicio]='15260-2023'

commit tran
 
select * from circulemos2.[dbo].[reconstr_docs_impugnaciones]

where [numero_juicio]='15260-2023'
 
 
exec circulemos2.dbo.sp_reconstruir_docs_impugnaciones;
