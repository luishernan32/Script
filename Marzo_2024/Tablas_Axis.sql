...
FETCH NEXT FROM cursor_ejemplo INTO @tipo_de_financiacion, @numero_de_convenio,@ID_ESTADO_DE_INCUMPLIMIENTO
WHILE @@FETCH_STATUS = 0
BEGIN
    -- Procesar la fila actual
    --PRINT 'ID: ' + CONVERT(VARCHAR, @tipo_de_financiacion) + ', NUMERO: ' + CONVERT(VARCHAR, @numero_de_convenio)

	INSERT INTO #TBLTEMPORAL VALUES (@tipo_de_financiacion,@numero_de_convenio)
